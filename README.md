...
### 3. **Voice Interaction**  
   - Text generated by the response engine is converted to speech using edge_tts, with speech rate and volume adjusted according to the recognized emotions.
...
c. **Speech customization capabilities**: edge_tts allows for customization of speech rate, volume, and tone based on the recognized emotions, enhancing the emotional expressiveness of the speech interactions.
...
### 2.Use a more advanced speech model API to generate a more cartoon-like voice (I am using edge_tts because I can't afford a premium platform subscription 😭).
